...
class Face_Recognition:
    ...
    def __init__(self, root):
        ...
        # Background image
        bg1 = Image.open(r"D:\bbhagya_project\Python_Test_Projects\Images_GUI\bg2.jpg")
        ...
        # Training button
        std_img_btn = Image.open(r"D:\bbhagya_project\Python_Test_Projects\Images_GUI\det1.jpg")
    ...
    def face_recog(self):
        ...
        def draw_boundray(img, classifier, scaleFactor, minNeighbors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                i = cursor.fetchone()
                if i:
                    i = "+".join(map(str, i))  # Convert the integer to a string before         joining
