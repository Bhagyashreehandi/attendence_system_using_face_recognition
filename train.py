...
#         # backgorund image 
#         bg1=Image.open(r"D:\bbhagya_project\Python_Test_Projects\Images_GUI\t_bg1.jpg")
...
#         # ------------------------------------------------------------------------------------------------------------------- 
#         # Training button 1
#         std_img_btn=Image.open(r"D:\bbhagya_project\Python_Test_Projects\Images_GUI\t_btn1.png")
    ...
    def train_classifier(self):
        ...
        for image in path:
            try:
                ...
                print(f"Filename format error: {image}")
                continue  # Skip files that don't match the expected format
            except ValueError:
                print(f"ID conversion error: {image}")
                continue  # Skip files where ID conversion fails

        if faces and ids:  # Ensure there are faces and IDs to train
            ids = np.array(ids)
            ...
            messagebox.showwarning("Warning", "No valid images found for training.", parent=self.root)
