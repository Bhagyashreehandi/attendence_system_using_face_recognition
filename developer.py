...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"D:\bbhagya_project\Python_Test_Projects\Images_GUI\f_det.jpg")
        ...
        std_b1_1 = Button(bg_img,text="Bhagyashree",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=250,y=380,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"D:\bbhagya_project\Python_Test_Projects\Images_GUI\sunita.jpg")
        ...
        det_b1_1 = Button(bg_img,text="Sunita",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=480,y=380,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"D:\bbhagya_project\Python_Test_Projects\Images_GUI\faizan.jpg")
        ...
        att_b1_1 = Button(bg_img,text="Faizan",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        att_b1_1.place(x=710,y=380,width=180,height=45)

         # Help  Support  button 4
        hlp_img_btn=Image.open(r"D:\bbhagya_project\Python_Test_Projects\Images_GUI\det1.jpg")
        ...
        hlp_b1_1 = Button(bg_img,text="Veeeresh",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
